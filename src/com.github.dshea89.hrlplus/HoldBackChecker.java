...
public class HoldBackChecker extends DataGenerator implements Serializable {
    ...
    public Vector counterexamplesFor(Conjecture var1, Theory var2, int var3) {
        ...
        if (var1 instanceof Equivalence) {
            String var5 = "";
            Equivalence var6 = (Equivalence)var1;
            ...
            for(var9 = 0; var9 < var8.size() && var3 > var4.size(); ++var9) {
                var5 = (String)var8.elementAt(var9);
                var10 = var6.lh_concept.calculateRow(var2.concepts, var5).tuples;
                var10.sort();
                var11 = var6.rh_concept.calculateRow(var2.concepts, var5).tuples;
                var11.sort();
        ...
        if (var1 instanceof Implication) {
            Implication var15 = (Implication)var1;
            var17 = "";
            ...
            for(var9 = 0; var9 < var8.size() && var3 > var4.size(); ++var9) {
                ...
                var10 = var15.lh_concept.calculateRow(var2.concepts, var17).tuples;
                var11 = var15.rh_concept.calculateRow(var2.concepts, var17).tuples;
                if (!var11.subsumes(var10)) {
                    Entity var19 = new Entity();
                    var19.name = var17;
                    var19.conjecture = var1;
                    var8.removeElementAt(var9);
        ...
        if (var1 instanceof NonExists) {
            NonExists var16 = (NonExists)var1;
            var17 = "";
            ...
            for(var9 = 0; var9 < var8.size() && var3 > var4.size(); ++var9) {
                var17 = (String)var8.elementAt(var9);
                var10 = var16.concept.calculateRow(var2.concepts, var17).tuples;
                if (!var10.isEmpty()) {
                    var8.removeElementAt(var9);
                    Entity var18 = new Entity();
                    var18.name = var17;
                    var18.conjecture = var1;
