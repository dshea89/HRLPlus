...
public class EntityDisjunct extends ProductionRule implements Serializable {
    ...
    public Vector newSpecifications(Vector concept_list, Vector parameters, Theory theory, Vector new_functions) {
        ...
        for(int var10 = 0; var10 < theory.concepts.size(); ++var10) {
            var9 = (Concept) theory.concepts.elementAt(var10);
        ...
        if (var9 == null) {
            ...
            for(int var12 = 0; var12 < parameters.size(); ++var12) {
                ...
                var14.addElement("0");
                var15.addElement((String) parameters.elementAt(var12));
                String var16 = (String) parameters.elementAt(var12);
                Concept var17 = new Concept();
                var17.specifications = theory.split.newSpecifications(var18, var13, theory, new Vector());
                var17.arity = 1;
            ...
            for(int var20 = 1; var20 < var11.size(); ++var20) {
                ...
                var19 = this.disjoinDummyConcepts(var19, var21, theory);
            }
    ...
    public Datatable transformTable(Vector old_datatables, Vector old_concepts, Vector parameters, Vector all_concepts) {
        ...
        for(int var7 = 0; var7 < var5.size(); ++var7) {
            ...
            if (parameters.contains(var8.entity)) {
